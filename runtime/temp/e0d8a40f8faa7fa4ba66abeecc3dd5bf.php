<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\wwwroot\zj.cc\public/../app/admin\view\default\sqs.html";i:1733206932;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\header.html";i:1733206450;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\footer.html";i:1688394438;}*/ ?>
 <!DOCTYPE html>
<html lang="zh">
<head>
...
<title><?php echo $webname; ?> - 授权信息</title>
    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              <header class="card-header"><div class="card-title">授权信息</div></header>
              <div class="card-body">
                ...
                <form action="" method="post" name="edit-form" class="edit-form">
                  <div class="tab-content">
                      ...
                      <div class="mb-3">
                        <label for="web_site_title" class="form-label">域名</label>
                        <textarea style="height:120px" class="form-control" name="domain"><?php echo $sq['domain']; ?></textarea>      
                      </div>


                      <div class="mb-3">
                        <label for="web_site_title" class="form-label">IP</label>
                        <input class="form-control" type="text" name="ip" value="<?php echo $sq['ip']; ?>" placeholder="">      
                      </div>


                      <div class="mb-3">
                        <label for="web_site_title" class="form-label">QQ</label>
                        <input class="form-control" type="text" name="qq" value="<?php echo $sq['qq']; ?>" placeholder="">      
                      </div>

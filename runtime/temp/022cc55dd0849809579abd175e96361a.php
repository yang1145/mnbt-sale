<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\wwwroot\zj.cc\public/../app/index\view\default\user\index.html";i:1735108758;s:56:"D:\wwwroot\zj.cc\app\index\view\default\user\header.html";i:1735109108;s:56:"D:\wwwroot\zj.cc\app\index\view\default\user\footer.html";i:1735108806;}*/ ?>
 <!doctype html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
        <title><?php echo $webname; ?> - 用户中心</title> 	
...
<?php endif; ?>
    ...
    <style>
        ...
        <b>
            <div>                        ID:<span class="text-primary"><?php echo $user['id']; ?></span></div>
            <div>                        名称:<?php echo $user['name']; ?></div>
            <div>                        余额:<span class="text-primary"><?php echo $user['money']; ?></span></div>
            </b>
        </div>
    </div>
...
<br/>
                            ...
                            <center>
                              <a class="btn btn-outline-primary btn-sm" href="/cart"><i class="fas fa-shopping-bag"></i> 订购产品</a>
                              </center>
                              </div>
                                                      <div class="col-4">
                                                      <center>
                              <a class="btn btn-outline-primary btn-sm" href="/user/pay"><i class="fas fa-wallet"></i> 余额充值</a>
                              </center>
                              </div>
                                                      <div class="col-4">
                                                     <center>
                              <a class="btn btn-outline-primary btn-sm" href="/user/information"><i class="fas fa-user-circle"></i> 修改资料</a>
                              </center>
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">管理产品(最近5条)</h3>
                         
      <a class="btn btn-outline-primary btn-sm" href="/user/order">查看更多 <i class="fas fa-chevron-right"></i></a>
...
<?php endif; ?>
    ...
    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">网站公告(最近5条)</h3>
                                                
      <a class="btn btn-outline-primary btn-sm" href="/announcement">查看更多 <i class="fas fa-chevron-right"></i></a>

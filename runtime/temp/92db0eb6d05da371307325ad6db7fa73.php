<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\wwwroot\zj.cc\public/../app/admin\view\default\info.html";i:1703402448;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\header.html";i:1738745069;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\footer.html";i:1688394438;}*/ ?>
 <!DOCTYPE html>
<html lang="zh">
<head>
...
<title><?php echo $webname; ?> - 个人信息</title>
              ...
              <div class="card-body">
                ...
                <form method="POST" action="" class="site-form signin-form needs-validation">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="name" placeholder="输入您的昵称" value="<?php echo $user['name']; ?>">
                  </div>

                  <div class="mb-3">
                    <label for="nickname">QQ</label>
                    <input type="text" class="form-control" name="qq" id="name" placeholder="输入您的QQ" value="<?php echo $user['qq']; ?>">
                  </div>
                  <div class="mb-3">
                    <label for="email">邮箱</label>
                    <input type="email" class="form-control" name="mail" id="mail" aria-describedby="emailHelp" placeholder="请输入正确的邮箱地址" value="<?php echo $user['mail']; ?>">

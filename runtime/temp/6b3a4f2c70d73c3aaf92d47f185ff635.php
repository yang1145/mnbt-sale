<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\wwwroot\zj.cc\public/../app/admin\view\default\user.html";i:1713439372;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\header.html";i:1738746062;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\footer.html";i:1688394438;}*/ ?>
 <!DOCTYPE html>
<html lang="zh">
<head>
...
<title><?php echo $webname; ?> - 用户管理</title>
...
<br/>
<button onclick='adduser()' class="btn btn-primary me-1">
<span class="mdi mdi-plus" aria-hidden="true"></span>添加用户
</button>
...
<td>
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ids" name="ids" value="<?php echo $u['id']; ?>">
...
<input type="hidden" value="<?php echo $u['id']; ?>" name="userid">
<button class="btn btn-primary btn-sm me-1"><i class="mdi mdi-account"></i>用户中心</button>
</form>
<br/>
<a href="/admin/user/<?php echo $u['id']; ?>" class="btn btn-success btn-sm me-1"><i class="mdi mdi-pencil"></i>查看信息</a>
...
<div style="text-align:center"><?php echo $users->render(); ?></div>
...
var id = id.join(",");
if(id==""){
layer.alert("未选择用户!",{icon:2,shade:0.8});
}else{
        layer.confirm('确定要删除ID为<span style="color:#0b5ed7">'+ id +'</span>的用户吗？', function (){
            del1(id)
        });
    }
}
...
function qbdel(){
        layer.confirm('确定要删除<span style="color:#0b5ed7">全部</span>的用户吗？', function (){
            qbdel1()
        });
    }
...
layer.open({
        ...
        shadeClose: true,
        title:"添加用户",
        content: '<div style="width:300px;height:400px;" class="card-body"><div class="mb-3"><label for="web_site_title" class="form-label">名称</label><input class="form-control" type="text" name="name" value="" placeholder=""></div><div class="mb-3"><label for="web_site_title" class="form-label">账号</label><input class="form-control" type="text" name="user" value="" placeholder=""></div><div class="mb-3"><label for="web_site_title" class="form-label">QQ</label><input class="form-control" type="text" name="qq" value="" placeholder=""></div><div class="mb-3"><label for="web_site_title" class="form-label">邮箱</label><input class="form-control" type="text" name="mail" value="" placeholder=""></div><div class="mb-3"><label for="web_site_title" class="form-label">密码</label><input class="form-control" type="text" name="password" placeholder="" value="" placeholder=""></div><button type="button" onclick="adduser1()" class="btn btn-primary me-1">添加</button><br/><br/></div>'   });

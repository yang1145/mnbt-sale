<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wwwroot\zj.cc\public/../app/admin\view\default\announcement.html";i:1713888556;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\header.html";i:1738745069;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\footer.html";i:1688394438;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<title><?php echo $webname; ?> - 公告列表 </title>
...
<span class="mdi mdi-plus" aria-hidden="true"></span>添加公告
</button>
...
<td>
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ids" name="ids" value="<?php echo $a['id']; ?>">
...
<td>
<a href="/admin/announcement/<?php echo $a['id']; ?>" class="btn btn-success btn-sm me-1"><i class="mdi mdi-pencil"></i>查看</a>
...
var id = id.join(",");
if(id==""){
layer.alert("未选择公告!",{icon:2,shade:0.8});
}else{
        layer.confirm('确定要删除ID为<span style="color:#0b5ed7">'+ id +'</span>的公告吗？', function (){
            del1(id)
        });
    }
}
...
function qbdel(){
        layer.confirm('确定要删除<span style="color:#0b5ed7">全部</span>的公告吗？', function (){
            qbdel1()
        });
    }
...
layer.open({
        ...
        shadeClose: true,
        title:"添加公告",
        content: '<div style="width:300px;height:400px" class="card-body"><div class="tab-content"><div class="mb-3"><label for="web_site_title" class="form-label">标题</label><input class="form-control" type="text" name="name" value="" placeholder=""></div><div class="mb-3"><label for="web_site_title" class="form-label">内容</label><textarea style="height:200px" class="form-control" type="text" name="information"></textarea></div><button type="button" onclick="add1()" class="btn btn-primary me-1">添加</button></div></div></div>',
  });

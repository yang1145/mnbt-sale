<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wwwroot\zj.cc\public/../app/admin\view\default\transferrecord.html";i:1728139428;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\header.html";i:1738745069;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\footer.html";i:1688394438;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<title><?php echo $webname; ?> - 产品过户记录</title>
...
<div class="card-title">产品过户记录</div>
</header>
        <div class="card-body">
...
<td>
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ids" name="ids" value="<?php echo $d['id']; ?>">
                            <label class="form-check-label" for="ids-1"></label>
                          </div>
                        </td>
                <td scope="row"><?php echo $d['id']; ?></td>
<td><?php echo $d['userid']; ?></td>
                <td><font class="text-success"><?php echo $d['record']; ?></font></td>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wwwroot\zj.cc\public/../app/admin\view\default\classifications.html";i:1730474182;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\header.html";i:1733206450;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\footer.html";i:1688394438;}*/ ?>
 <!DOCTYPE html>
<html lang="zh">
<head>
...
<title><?php echo $webname; ?> - 分类信息</title>
              ...
              <div class="card-body">
                ...
                <form action="" method="post" name="edit-form" class="edit-form">
                  <div class="tab-content">
                      ...
                      <div class="mb-3">
                        <label for="web_site_title" class="form-label">标题</label>
                        <input class="form-control" type="text" name="name" value="<?php echo $product['name']; ?>" placeholder="">      
                      </div>

                      <div class="mb-3">
                        <label for="web_site_title" class="form-label">介绍</label>
                        <textarea style="height:200px" class="form-control" type="text" name="introduce"><?php echo $product['introduce']; ?></textarea>
                      </div>
                      <div class="mb-3">
                        <label for="web_site_title" class="form-label">排序</label>

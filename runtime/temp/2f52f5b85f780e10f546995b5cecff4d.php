<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\wwwroot\zj.cc\public/../app/admin\view\default\pay.html";i:1728139438;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\header.html";i:1733206450;s:51:"D:\wwwroot\zj.cc\app\admin\view\default\footer.html";i:1688394438;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<title><?php echo $webname; ?> - 充值记录</title>
...
<td><?php echo date("Y-m-d H:i:s",$p['time']); ?></td>
     <td>
<?php if($p['state']=="1"): ?><a class="text-success">已支付</a><?php endif; if($p['state']=="2"): ?><a class="text-danger">未支付</a><?php endif; ?>
</td>
              </tr>
<?php endforeach; ?>
            </tbody>
...
<div style="text-align:center"><?php echo $pay->render(); ?></div>
